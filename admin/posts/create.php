        ...
        <div class="posts col-9">
            ...
            <div class="row add-post">
                ...
                <form action="create.php" method="post" enctype="multipart/form-data">
                    <div class="col mb-4">
                        <input value="<?=$title; ?>" name="title" type="text" class="form-control" placeholder="Title" aria-label="Название блюда">
                    </div>
                    <div class="col">
                    ...
                    <div class="col col-6">
                        <button name="add_post" class="btn btn-primary" type="submit">Добавить блюдо</button>
                    </div>
                </form>
            </div>
